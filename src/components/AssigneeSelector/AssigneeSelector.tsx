...
const AssigneeSelector = ({ ticketId, currentAssigneeId, readonly = false, onUpdate }: AssigneeSelectorProps) => {
    ...
    if (readonly) {
        ...
        return (
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span>{currentAssignee.firstName} {currentAssignee.lastName}</span>
            </div>
        );
    }
    ...
    const dropdownContent = (
        ...
        >
            <div style={{ padding: '8px', borderBottom: '1px solid var(--border-color)', fontSize: '0.85rem', fontWeight: 'bold', color: 'var(--text-secondary)' }}>
                Assign to...
            </div>
            {users?.map(user => (
                <div
