    ...
    <section className="hero">
      <div className="hero-content">
        ...
        <p className="hero-subtitle">
          Manage your {TERMINOLOGY.items.toLowerCase()} efficiently with our modern matter
          management system. Track progress, collaborate with your team, and get things done.
        </p>
